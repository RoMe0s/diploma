...
class MaximumNumberOfLettersInTheParagraph implements TranslatorInterface
{
    /**
     * @param string $key
     * @param $value
    ...
    {
        return $key === 'settings.MaximumNumberOfLettersInTheParagraph'
                    && is_array($value)
    ...
    {
        return sprintf(
            __('check_errors.settings.MaximumNumberOfLettersInTheParagraph'),
            $value['part'],
            $value['got'],
            $value['excpected']
        );
