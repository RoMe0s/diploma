...
class MaximumNumberOfLettersInTheTitle implements TranslatorInterface
{
    /**
     * @param string $key
     * @param $value
    ...
    {
        return $key === 'settings.MaximumNumberOfLettersInTheTitle'
            && is_array($value)
    ...
    {
        return sprintf(
            __('check_errors.settings.MaximumNumberOfLettersInTheTitle'),
            $value['part'],
            $value['got'],
            $value['excpected']
        );
