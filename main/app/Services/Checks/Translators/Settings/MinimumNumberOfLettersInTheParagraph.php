...
class MinimumNumberOfLettersInTheParagraph implements TranslatorInterface
{
    /**
     * @param string $key
     * @param $value
    ...
    {
        return $key === 'settings.MinimumNumberOfLettersInTheParagraph'
            && is_array($value)
    ...
    {
        return sprintf(
            __('check_errors.settings.MinimumNumberOfLettersInTheParagraph'),
            $value['part'],
            $value['got'],
            $value['excpected']
        );
